...
Citizen.CreateThread(function()
	while true do
		...
		if (current_zone == nil) then
			TriggerServerEvent("server:get_zone")
...
RegisterNetEvent("client:draw_zone")
AddEventHandler("client:draw_zone", function(source)
	current_zone = source
	RemoveBlip(zone)
...
RegisterNetEvent("client:draw_blip")
AddEventHandler("client:draw_blip", function(draw_route, blip_text, blip_id)
	RemoveBlip(blip)
